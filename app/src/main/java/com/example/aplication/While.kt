...
import com.example.aplication.databinding.WhileBlockBinding

class While_block  constructor (
    context: Context,
    attrs: AttributeSet?=null,
    defStyleAttr: Int=0) :CoordinatorLayout(context, attrs, defStyleAttr) {
    private val binding2 = WhileBlockBinding.inflate(LayoutInflater.from(context), this)
...
//    }
    ...
    fun GetText2():String {
        val textview2= binding2.textInput
