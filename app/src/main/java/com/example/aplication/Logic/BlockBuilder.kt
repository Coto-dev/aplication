...
fun pushDataForInput(editText: String, alertText: String, index: Int) {
    val a = Input()
    a.textBar = editText
    a.stack = alertText
    listOfBlocks[index] = a
...
fun swapBlocks(blockIndexA: Int, blockIndexB: Int) {
    listOfBlocks[blockIndexA] =
        listOfBlocks[blockIndexB].also { listOfBlocks[blockIndexB] = listOfBlocks[blockIndexA] }
}